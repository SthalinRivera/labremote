...
<template>
    <UDashboardPanel id="dashboard">
        <template #header>
            <UDashboardNavbar title="Dashboard - Camara en vivo" :ui="{ right: 'gap-3' }">
                <template #leading>
                ...
                <div class="container mx-auto px-4 py-6 max-w-7xl">
                    ...
                    <div class="flex flex-wrap justify-between items-center gap-3 mb-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Jetson Nano - Detección en tiempo real
                            </p>
                        </div>
                    ...
                    <UCard class="overflow-hidden p-0">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <UBadge v-if="lab.session" color="green" variant="solid" size="xs">Sesión activa
                                </UBadge>
                            </div>
                        ...
                        <div class="relative bg-black" style="min-height: 60vh;">
                            ...
                            <!-- Iframe -->
                            <iframe ref="iframeRef" :src="camUrl" class="w-full h-[65vh]" frameborder="0"
                                allow="autoplay" @load="onCamLoad" @error="onCamError" />
                            <!-- Overlay informativo -->
                            <div
                                class="absolute bottom-3 left-3 bg-black/60 backdrop-blur-sm px-3 py-1 rounded-md text-xs">
                    ...
                    <UCard class="mt-6">
                        ...
                        <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                            <p>La cámara muestra el entorno del laboratorio remoto donde se encuentra la Jetson Nano.
                                Podrás
                                observar:</p>
                            ...
                            <p class="mt-2 text-yellow-600 dark:text-yellow-400 flex items-center gap-1">
                                ...
                                <span>No actualices la página mientras la sesión esté activa para no perder el
                                    stream.</span>
                            </p>
                        </div>
                    </UCard>
