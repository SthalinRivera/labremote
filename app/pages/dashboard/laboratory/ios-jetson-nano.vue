...
<template>
  ...
  <UDashboardPanel id="dashboard">
    <template #header>
      <UDashboardNavbar title="Dashboard - IOS Jelson Nano" :ui="{ right: 'gap-3' }">
        <template #leading>
        ...
        <div class="mt-6 grid md:grid-cols-3 gap-4">
          <UCard class="md:col-span-1 overflow-hidden p-0">
            ...
            <div class="relative bg-black aspect-video">
              ...
              <iframe ref="camIframe" :src="camUrl" class="w-full h-full" frameborder="0" allow="autoplay"
          ...
          <UCard class="md:col-span-2">
            ...
            <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <li class="flex gap-2">
                <UIcon name="i-lucide-check" class="w-4 h-4 text-green-500 mt-0.5" /> La cámara muestra en tiempo real
                el
                hardware.
              </li>
              <li class="flex gap-2">
                <UIcon name="i-lucide-check" class="w-4 h-4 text-green-500 mt-0.5" /> Al finalizar, cierra sesión desde
                el
                panel de
                control.
              </li>
